"""
This script is called by the plugin-wrapper, MiniProjectCodeGenerator.js, which passes down the
...
from MiniProjectCodeGenerator import MiniProjectCodeGenerator
...
plugin = MiniProjectCodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
